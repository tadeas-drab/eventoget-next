        ...
        <div>
            ...
            <div className='white-bg pt-5 pb-3'>
                <div className='container'>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <h1 className='mb-3'><img src="/images/instagram.svg" className='icon'/>&nbsp;@tripseek</h1>
                            <h1 className='mb-3'><img src="/images/messenger.svg" className='icon'/>&nbsp;Tripseek</h1>
                            <h1 className='mb-3'><img src="/images/linkedin.svg" className='icon'/>&nbsp;@tripseek</h1>
                            <h1 className='mb-3'><img src="/images/youtube.svg" className='icon'/>&nbsp;Tripseek</h1>
                        </div>
