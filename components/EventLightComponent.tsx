...
const EventLightComponent: NextPage<Event> = ({ Id, ImageUrl, ArtistName, DisplayLocation, StartDate }) => {
    return (
        <div className='col-3'>
            <div className='card-light mt-3'>
...
export default EventLightComponent